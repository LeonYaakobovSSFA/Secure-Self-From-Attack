...
echo "<--✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡-->"
echo "<--[|---✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡---|]-->"
echo "<--[|---✡ ✡Security Script 2017✡     ✡I-S-R-A-E-L✡  ✡---|]-->"	
echo "<--[|---✡ ✡written by {Leon Yaakobov [SSFA]} in 2017 ✡---|]-->"
echo "<--[|---✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡---|]-->"
echo "<--✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡-->"
echo ""
echo $BLUE"            +######################+"
...
echo $BLUE"            +######################+"
echo $RED"            +##############################+"
echo $RED"            +#   L.Y SSFA Security Script #+" 
echo $RED"            +##############################+"
echo $GREEN"            +#####################################+"
echo $GREEN"            +#   Visit my site: www.lyssfa.co.il #+"
echo $GREEN"            +#####################################+"
echo ""
echo ""
